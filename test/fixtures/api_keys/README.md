...
`daily_budget_usd`, `max_budget_usd`, `spent_today_usd`, `spent_total_usd`, `pod_visibility`, `pods_count` beside the DAH-2944
...
- `keys.json` — two keys of the Research workspace: `agent-1` (read, rent; $20/day, $200 total; visibility `own`; 1 pod) and `ops` (no budget; visibility `account`; 0 pods).
