...
They subclass paramiko at class-creation time, so they live in this module; ``client.py`` imports
paramiko lazily and imports this module inside ``ssh_connection``. The path-side
