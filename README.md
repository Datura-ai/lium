...
- `lium topup card -a <USD> [--card <pm_id>]` - Charge a card saved on the account, with no browser; the API key needs the `billing` scope (lium-platform#631, not released)
